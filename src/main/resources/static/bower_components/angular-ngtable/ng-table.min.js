    ...
    return b.value("ngTableDefaults",{
        ...
        var e=function(a){
            ...
            this.data=[],this.parameters=function(b,c){
                ...
                var a=[];
                for(var b in j.sorting)a.push(("asc"===j.sorting[b]?"+":"-")+b);return a
                ...
                return e.promise.then(function(b){
                    ...
                    var f=[];
                    for(var g in e)f.push(e[g]);i("ngTable: refresh groups",f),c.resolve(f)
                }),this.getData(e,h)
        ...
        a.put("ng-table/pager.html",'<div class="ng-cloak ng-table-pager" ng-if="params.data.length"> \n\
...
class="btn btn-default">\n\
 ...
 </div> <ul class="pagination ng-table-pagination">\n\
...
<a ng-switch-when="next" ng-click="params.page(page.number)" href="">&raquo;</a> </li> </ul> </div> ')
    }]),b
});
